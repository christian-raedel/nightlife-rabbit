        ...
        switch (message.type) {
            case 'HELLO':
                q.fcall(function () {
                    ...
                    self.roles = _.merge(self.roles, message.details.roles);
