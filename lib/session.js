        ...
        switch (message.type) {
            ...
            case 'PUBLISH':
                ...
                .then(function (topic) {
                    ...
                    var queue = [];
                    _.forOwn(topic.sessions, function (session) {
                ...
                .catch(function (err) {
                    ...
                    self.send('ERROR', {request: {type: 'PUBLISH', id: message.request.id}, details: {}, error: 'wamp.error.publish_error'});
                });
                break;
            case 'REGISTER':
                q.fcall(function () {
                ...
                .catch(function (err) {
                    ...
                    self.send('ERROR', {request: {type: 'REGISTER', id: message.request.id}, details: {}, error: 'wamp.error.register_error'});
                });
                break;
            case 'UNREGISTER':
                q.fcall(function () {
                ...
                .catch(function (err) {
                    ...
                    self.send('ERROR', {request: {type: 'UNREGISTER', id: message.request.id}, details: {}, error: 'wamp.error.unregister_error'});
                });
                break;
            default:
