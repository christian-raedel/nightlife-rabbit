...
Message.prototype.set = function (path) {
    ...
    if (path.match(/args/) && !value) {
        value = [];
    } else if (path.match(/kwargs/) && !value) {
        value = {};
    }
    _.merge(this.obj, deep.set(path, value));
    return this;
};
...
var TYPES = {
    ...
    8  : {
        type   : 'ERROR',
        encode : '[{{type}}, {{request.type|type}}, {{request.id|id}}, {{details|dict}}, {{error|uri}}, {{args|list|optional}}, {{kwargs|dict|optional}}]',
        decode : function (data) {
